      ...
      >
        ...
        >
          ...
          >
            ...
            <!--begin::Item-->
            <li class="breadcrumb-item text-muted">Specialités</li>
            <!--end::Item-->
          </ul>
          <!--end::Breadcrumb-->
        </div>
      ...
      <div class="card-body py-4">
        <div class="table-responsive">
          <table class="table table-row-dashed table-row-gray-300 gy-7">
            ...
            <tbody
              v-loading="specialiteStore.specialiteLoader"
              element-loading-background="#151521"
            >
              <tr
                v-for="(specialite, index) in specialiteStore.specialites"
                :key="index"
              >
                <td>{{ specialite.id }}</td>
        ...
        <div class="row">
          ...
          >
            <table-pagination
              :currentPage="page"
              :perPage="perPage"
              :totalPages="specialiteStore.specialiteTotalPages"
              :total="specialiteStore.specialiteTotal"
      ...
      <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h5 class="modal-title" v-else>Modifier specialite</h5>
  ...
  methods: {
    ...
    deleteItem(item) {
      Swal.fire({
        ...
        if (response.value) {
          this.specialiteStore.delete_specialite(item).then((response) => {
            if (response) {
              this.setup();
              ElNotification({
                title: "Succès",
                message: "La specialite a été supprimée.",
    ...
    handleStore() {
      ...
      if (!this.current_edit) {
        this.specialiteStore
          .store_specialite(this.new_specialite)
          .then((valid) => {
            ...
            if (valid) {
              ...
              ElNotification({
                title: "Succès",
                message: "Specialite ajouté avec succès",
                position: "bottom-left",
                type: "success",
                customClass: "alert-success",
              });
        ...
        this.specialiteStore
          .edit_specialite(this.new_specialite)
          .then((valid) => {
            submitButtonRef.disabled = false;
            submitButtonRef?.removeAttribute("data-kt-indicator");
            if (valid) {
              ...
              ElNotification({
                title: "Succès",
                message: "Specialite modifié avec succès",
                position: "bottom-left",
                type: "success",
                customClass: "alert-success",
              });
